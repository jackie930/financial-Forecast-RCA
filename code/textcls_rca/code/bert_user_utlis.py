...
class BertClassifier(nn.Module):
    ...
    def __init__(self, bert_model, dropout=0.1, bert_emb_size=768, user_emb_size=256, bert_freeze=False):
...
def train_model(model, train_dataset, val_dataset, auroc, user_embeddings, learning_rate, epochs, batch_size):
...
def evaluate_model(model, test_dataset, auroc, user_embeddings, batch_size):
